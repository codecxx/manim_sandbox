...
from MyAnimations.quadratic_equation.svg_classes import CheckFormulaByTXT
from io import *
...
for i in range(1,17):
	formula_open=open(r"C:\FromLaptop\manim_sandbox\MyAnimations\quadratic_equation\formulas\formula%de.txt"%i,"r")
