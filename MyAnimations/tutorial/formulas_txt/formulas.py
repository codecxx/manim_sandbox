...
from MyAnimations.tutorial.svg_classes import CheckFormulaByTXT
from io import *
...
for i in range(1,17):
	formula_open=open(r"C:\FromLaptop\manim_sandbox\MyAnimations\tutorial\formulas_txt\formula%de.txt"%i,"r")
