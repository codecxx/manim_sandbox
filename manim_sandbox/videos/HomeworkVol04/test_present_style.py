...
class Emote(SVGMobject):
    ...
    CONFIG = {
        'file_name': r'C:\FromLaptop\manim_sandbox\manim_sandbox\assets\svg_images\cat.svg',
...
class Emote_new(VGroup):
    CONFIG = {
        'file_name': r'C:\FromLaptop\manim_sandbox\manim_sandbox\videos\manimTutorial\part1_Mobjectmethod\emote_01.svg',
        'shake_color': average_color(YELLOW, ORANGE),
        'height': 2.5,
    }
    def __init__(self, **kwargs):
