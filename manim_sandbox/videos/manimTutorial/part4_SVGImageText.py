...
class UseSVG(Scene_):
    ...
    def construct(self):
        ...
        mob = SVGMobject(r"C:\FromLaptop\manim_sandbox\assets\svg_images\coin.svg", color=BLUE, stroke_width=0)
...
class UseImage(Scene_):
    ...
    def construct(self):
        ...
        codebg = CodeBackground(codes)
        img = ImageMobject(r"C:\FromLaptop\manim_sandbox\manim_projects\documents\Grant.png", height=2).shift(LEFT*4)
        img2 = ImageMobject(r"C:\FromLaptop\manim_sandbox\manim_projects\documents\Grant.png", height=3, invert=True).shift(LEFT*4)
        self.play(FadeInFromDown(codebg))
        self.play(Write(VGroup(codes[0], codes[4])))
        self.wait(2)
        self.next_caps()
...
class UseTexMobject(Scene_):
    def construct(self):
        ...
        img = ImageMobject(r"C:\FromLaptop\manim_sandbox\assets\raster_images\logo.png", height=8)
        ...
        self.wait(3)
        img2 = ImageMobject(r"C:\FromLaptop\manim_sandbox\assets\raster_images\title.png", height=8)
...
class UseText(Scene_):
    def construct(self):
        ...
        for i, j in enumerate(text):
            ...
            self.play(FadeInFromLarge(index[-1]), run_time=0.5)
        self.wait(5)
        img = ImageMobject(r"C:\FromLaptop\manim_sandbox\assets\raster_images\title.png", height=8)
