...
class FourierOfMisaka(FourierOfTrebleClef):
    CONFIG = {
        "file_name": "assets\\svgs\\misaka.svg",
        "run_time": 10,
        "slow_factor": 0.01,
        "n_vectors": 500,
        "n_cycles": 1,
...
class FourierOfMisakaZoomedIn(FourierOfMisaka, ZoomedInFourierSeriesExample):
    pass


class FourierOfDeer(FourierOfTrebleClef):
    CONFIG = {
        "file_name": "assets\\svgs\\deer.svg",
        "run_time": 10,
        "slow_factor": 0.01,
        "n_vectors": 500,
        "n_cycles": 1,
...
class FourierOfDeerZoomedIn(FourierOfDeer, ZoomedInFourierSeriesExample):
    pass


class FourierOfCouple(FourierOfTrebleClef):
    CONFIG = {
        "file_name": "assets\\svgs\\couple.svg",
        "run_time": 10,
        "slow_factor": 0.01,
        "n_vectors": 500,
        "n_cycles": 1,
...
class FourierOfCoupleZoomedIn(FourierOfCouple, ZoomedInFourierSeriesExample):
    pass



class JMC_test(FourierSeriesExampleWithRectForZoom):
    CONFIG = {
        "n_vectors": 200,
        "drawn_path_color": PINK,
        "rect_stroke_width": 0,
...
class JMC_testZoomedInFourierSeriesExample(JMC_test, ZoomedInFourierSeriesExample):
    pass
